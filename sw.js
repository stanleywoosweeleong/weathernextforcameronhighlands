...
// Version 1.0.231 — row reorder: moved VPD up to the spray cluster (now temp[DeltaT/SafeHours] -> wind -> VPD), grouping all spray-timing signals together. Wetness/disease cluster (RH -> leaf-wetness -> fog) and rain block left intact. New order: WVET,temp,wind,VPD,cloud,storm,sky,rainPP,rainMM,RH,leafwet,fog,ET0. bump CACHE_VERSION on each release
// ============================================================

const CACHE_VERSION = 'wnext-weathernextforcameron-202605311556';

...
// Version 1.0.202 — language toggle now re-renders microclimate panel + past strips instantly (5 langs, EN fallback) and preserves scroll position. bump CACHE_VERSION on each release
// ============================================================

const CACHE_VERSION = 'wnext-weathernextforcameron-202606012010';
